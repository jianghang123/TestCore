...
namespace TestCore.Common.Cache
{
    ...
    public partial class RedisCacheManager:IStaticCacheManager
    {
        ...
        private readonly TestCoreConfig _testCoreConfig;
        ...
        protected virtual async Task RemoveAsync(string key)
        {
            ...
            if (key.Equals(TestCoreCachingDefaults.RedisDataProtectionKey, StringComparison.OrdinalIgnoreCase))
                return;
        ...
        protected virtual async Task RemoveByPatternAsync(string pattern)
        {
            ...
            foreach (var endPoint in _connectionWrapper.GetEndPoints())
            {
                ...
                //we should always persist the data protection key list
                keys = keys.Where(key => !key.ToString().Equals(TestCoreCachingDefaults.RedisDataProtectionKey, StringComparison.OrdinalIgnoreCase));
