...
{
    /// <summary>
    /// A class that finds types needed by Caiba by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected ITestCoreFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(ITestCoreFileProvider fileProvider = null)
        {
