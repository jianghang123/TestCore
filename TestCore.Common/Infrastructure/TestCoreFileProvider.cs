...
{
    public class TestCoreFileProvider : PhysicalFileProvider, ITestCoreFileProvider
    {
        protected string BaseDirectory { get; }
        /// <summary>
        /// Initializes a new instance of a CaibaFileProvider
        /// </summary>
        /// <param name="hostingEnvironment">Hosting environment</param>
        public TestCoreFileProvider(IHostingEnvironment hostingEnvironment)
