...
namespace TestCore.Common.PayCommon.Wxpay
{
    ...
    {
        private ILog Log = LogUtils.GetLogger(typeof(WxPayData));
        ...
        public WxPayData(SortedDictionary<string, object> values)
        {
            m_values = values;
        }
        ...
        */
        public string ToPrintStr()
        {
            ...
            Log.Debug( "Print in Web Page : " + str);
            return str;
        }
        ...
        */
        public string MakeSign()
        {
            ...
            string str = ToUrl();
            //在string后加入API KEY
            str += "&key=" + _settings.Value.PaySetting.WxPay.Key;
            //MD5加密
            var md5 = MD5.Create();
