...
namespace Microsoft.AspNetCore.Mvc
{
    public static class RequestExtensions
    {
        ...
        public static int  GetClientType(this HttpRequest request)
        {
            return (int)GetClientTypeEnum(request);
        }


        public static ClientTypeEnum GetClientTypeEnum(this HttpRequest request)
        {
            if (IsMobileBrowser(request))
            {
                return ClientTypeEnum.Wap;
            }
